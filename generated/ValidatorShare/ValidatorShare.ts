...
export class ValidatorShareApproval extends ethereum.Event {
  get params(): ValidatorShareApproval__Params {
    return new ValidatorShareApproval__Params(this);
  }
}

export class ValidatorShareApproval__Params {
  _event: ValidatorShareApproval;

  constructor(event: ValidatorShareApproval) {
    this._event = event;
  }
...
export class ValidatorShareTransfer extends ethereum.Event {
  get params(): ValidatorShareTransfer__Params {
    return new ValidatorShareTransfer__Params(this);
  }
}

export class ValidatorShareTransfer__Params {
  _event: ValidatorShareTransfer;

  constructor(event: ValidatorShareTransfer) {
    this._event = event;
  }

...
export class BoneTokenApproval extends ethereum.Event {
  get params(): BoneTokenApproval__Params {
    return new BoneTokenApproval__Params(this);
  }
}

export class BoneTokenApproval__Params {
  _event: BoneTokenApproval;

  constructor(event: BoneTokenApproval) {
    this._event = event;
  }
...
export class BoneTokenOwnershipTransferred extends ethereum.Event {
  get params(): BoneTokenOwnershipTransferred__Params {
    return new BoneTokenOwnershipTransferred__Params(this);
  }
}

export class BoneTokenOwnershipTransferred__Params {
  _event: BoneTokenOwnershipTransferred;

  constructor(event: BoneTokenOwnershipTransferred) {
    this._event = event;
  }
...
export class BoneTokenTransfer extends ethereum.Event {
  get params(): BoneTokenTransfer__Params {
    return new BoneTokenTransfer__Params(this);
  }
}

export class BoneTokenTransfer__Params {
  _event: BoneTokenTransfer;

  constructor(event: BoneTokenTransfer) {
    this._event = event;
  }
...
export class BoneToken extends ethereum.SmartContract {
  ...
  try_checkpoints(
    ...
    return ethereum.CallResult.fromValue(
      new BoneToken__checkpointsResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }

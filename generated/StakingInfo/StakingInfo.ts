...
export class StakingInfoUpdateCommissionRate extends ethereum.Event {
  get params(): StakingInfoUpdateCommissionRate__Params {
    return new StakingInfoUpdateCommissionRate__Params(this);
  }
}

export class StakingInfoUpdateCommissionRate__Params {
  _event: StakingInfoUpdateCommissionRate;

  constructor(event: StakingInfoUpdateCommissionRate) {
    this._event = event;
  }

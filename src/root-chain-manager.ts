import {
  ...
  RootChainManagerTokenMapped as RootChainManagerTokenMappedEvent
...
export function handleRootChainManagerTokenMapped(
  event: RootChainManagerTokenMappedEvent
): void {
  let entity = new RootChainManagerTokenMapped(
    event.transaction.hash.toHex() + "-" + event.logIndex.toString()
  )

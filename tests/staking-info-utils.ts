...
import {
  ...
  UnstakeInit,
  Unstaked,
  StakingInfoUpdateCommissionRate
...
export function createStakingInfoUpdateCommissionRateEvent(
  validatorId: BigInt,
  newCommissionRate: BigInt,
  oldCommissionRate: BigInt
): StakingInfoUpdateCommissionRate {
  let stakingInfoUpdateCommissionRateEvent = changetype<
    StakingInfoUpdateCommissionRate
  >(newMockEvent())

  stakingInfoUpdateCommissionRateEvent.parameters = new Array()

  stakingInfoUpdateCommissionRateEvent.parameters.push(
    new ethereum.EventParam(
      "validatorId",
      ethereum.Value.fromUnsignedBigInt(validatorId)
    )
  ...
  return stakingInfoUpdateCommissionRateEvent
}

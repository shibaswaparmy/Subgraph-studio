...
export function createEventsHubUpdateCommissionRateEvent(
  validatorId: BigInt,
  newCommissionRate: BigInt,
  oldCommissionRate: BigInt
): EventsHubUpdateCommissionRate {
  let eventsHubUpdateCommissionRateEvent = changetype<
    EventsHubUpdateCommissionRate
  >(newMockEvent())

  eventsHubUpdateCommissionRateEvent.parameters = new Array()

  eventsHubUpdateCommissionRateEvent.parameters.push(
    new ethereum.EventParam(
      "validatorId",
      ethereum.Value.fromUnsignedBigInt(validatorId)
    )
  ...
  return eventsHubUpdateCommissionRateEvent
}
